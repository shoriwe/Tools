...
class Scanner:
    def __init__(self, host: str, family: AddressFamily, target_protocols: list, port_range: iter, max_n_threads: int):
        ...
        # [[TCP ports], [UDP ports]]
        self.__db = {'0': ['None', 'In programming APIs '], '1': ['TCP Port Service Multiplexer '],
                     '5': ['Remote Job Entry'], '7': ['Echo Protocol'], '9': ['Discard Protocol', 'Wake-on-LAN'],
                     '11': ['Active Users '], '13': ['Daytime Protocol'], '15': ['Previously netstat service'],
                     '17': ['Quote of the Day '], '18': ['Message Send Protocol'],
                     '19': ['Character Generator Protocol '], '20': ['File Transfer Protocol '],
                     '21': ['File Transfer Protocol '], '22': ['Secure Shell '],
                     '23': ['Telnet protocolâ€”unencrypted text communications'],
                     '25': ['Simple Mail Transfer Protocol '], '37': ['Time Protocol'],
                     ...
                     '52': ['Xerox Network Systems '], '53': ['Domain Name System '], '54': ['Xerox Network Systems '],
                     '56': ['Xerox Network Systems '], '58': ['Xerox Network Systems '],
                     '61': ['Historically assigned to the NIFTP Based Mail protocol,'], '67': ['Bootstrap Protocol '],
                     '68': ['Bootstrap Protocol '], '69': ['Trivial File Transfer Protocol '],
                     '70': ['Gopher protocol'], '79': ['Finger protocol'],
                     '80': ['Hypertext Transfer Protocol ', 'Quick UDP Internet Connections '],
                     '81': ['TorPark onion routing'], '82': ['TorPark control'], '88': ['Kerberos'],
                     '90': ['PointCast '], '101': ['NIC host name'], '102': ['ISO Transport Service Access Point '],
                     '104': ['Digital Imaging and Communications in Medicine '], '105': ['CCSO Nameserver'],
                     '107': ['Remote User Telnet Service '], '108': ['IBM Systems Network Architecture '],
                     '109': ['Post Office Protocol, version 2 '], '110': ['Post Office Protocol, version 3 '],
                     ...
                     '115': ['Simple File Transfer Protocol'], '117': ['UUCP Mapping Project '],
                     '118': ['Structured Query Language '], '119': ['Network News Transfer Protocol '],
                     '123': ['Network Time Protocol '], '126': [
                "Formerly Unisys Unitary Login, renamed by Unisys to NXEdit. Used by Unisys Programmer's Workbench for Clearpath MCP, an IDE for Unisys MCP software development"],
                     ...
                     '143': ['Internet Message Access Protocol '], '152': ['Background File Transfer Program '],
                     '153': ['Simple Gateway Monitoring Protocol '], '156': ['Structured Query Language '],
                     '158': ['Distributed Mail System Protocol '], '161': ['Simple Network Management Protocol '],
                     '162': ['Simple Network Management Protocol Trap '], '170': ['Network PostScript print server'],
                     '177': ['X Display Manager Control Protocol '], '179': ['Border Gateway Protocol '],
                     '194': ['Internet Relay Chat '], '201': ['AppleTalk Routing Maintenance'],
                     '209': ['Quick Mail Transfer Protocol'], '210': ['ANSI Z39.50'],
                     ...
                     '300': ['ThinLinc Web Access'], '308': ['Novastor Online Backup'],
                     '311': ['Mac OS X Server Admin'], '318': ['PKIX Time Stamp Protocol '],
                     '319': ['Precision Time Protocol '], '320': ['Precision Time Protocol '],
                     '350': ['Mapping of Airline Traffic over Internet Protocol '], '351': ['MATIP type B'],
                     '356': ['cloanto net 1 '], '366': ['On Demand Mail Relay '], '369': ['Rpc2portmap'],
                     '370': ['codaauth2, Coda authentication server',
                             "securecast1, outgoing packets to NAI's SecureCast servers"], '371': ['ClearCase albd'],
                     '383': ['HP data alarm manager'], '384': ['A Remote Network Server System'], '387': ['AURP '],
                     '388': ['Unidata LDM near real time data distribution protocol'],
                     '389': ['Lightweight Directory Access Protocol '],
                     '399': ['Digital Equipment Corporation DECnet '], '401': ['Uninterruptible power supply '],
                     '427': ['Service Location Protocol '], '433': ['NNSP, part of Network News Transfer Protocol'],
                     '434': ['Mobile IP Agent '],
                     ...
                     '465': ['URL Rendezvous Directory for SSM ', 'Authenticated SMTP'],
                     ...
                     '512': ['Rexec, Remote Process Execution', 'comsat, together with biff'], '513': ['rlogin', 'Who'],
                     ...
                     '533': ['netwall, For Emergency Broadcasts'], '540': ['Unix to Unix Copy Protocol '],
                     '542': ['commerce '], '543': ['klogin, Kerberos login'], '544': ['kshell, Kerberos Remote shell'],
                     '546': ['DHCPv6 client'], '547': ['DHCPv6 server'], '548': ['Apple Filing Protocol '],
                     '550': ['new rwho, new who'], '554': ['Real Time Streaming Protocol '],
                     '556': ['Remotefs, RFS, rfs_server'], '560': ['rmonitor, Remote Monitor'], '561': ['monitor'],
                     '563': ['NNTP over TLS/SSL '], '564': ['9P '],
                ...
                'HTTP RPC Ep Map, Remote procedure call over Hypertext Transfer Protocol, often used by Distributed Component Object Model services and Microsoft Exchange Server'],
                     ...
                     '648': ['Registry Registrar Protocol '], '651': ['IEEE MMS'],
                     '653': ['SupportSoft Nexus Remote Command '], '654': ['Media Management System '],
                     '655': ['Tinc VPN daemon'], '657': ['IBM RMC '], '660': ['Mac OS X Server administration,'],
                     ...
                     '701': ['Link Management Protocol '], '702': ['IRIS'],
                     '706': ['Secure Internet Live Conferencing '], '711': ['Cisco Tag Distribution Protocol'],
                     '712': ['Topology Broadcast based on Reverse Path Forwarding routing protocol '],
                     '749': ['Kerberos '], '750': ['kerberos iv, Kerberos version IV'],
                     '751': ['kerberos_master, Kerberos authentication'], '752': ['passwd_server, Kerberos password '],
                     ...
                     '829': ['Certificate Management Protocol'], '830': ['NETCONF over SSH'],
                     '831': ['NETCONF over BEEP'], '832': ['NETCONF for SOAP over HTTPS'],
                     '833': ['NETCONF for SOAP over BEEP'], '843': ['Adobe Flash'], '847': ['DHCP Failover protocol'],
                     '848': ['Group Domain Of Interpretation '], '853': ['DNS over TLS '], '860': ['iSCSI '],
                     '861': ['OWAMP control '], '862': ['TWAMP control '],
                     '873': ['rsync file synchronization protocol'],
                     '888': ['cddbp, CD DataBase ', 'IBM Endpoint Manager Remote Control'],
                     '897': ['Brocade SMI S RPC'], '898': ['Brocade SMI S RPC SSL'], '902': ['VMware ESXi'],
                     '903': ['VMware ESXi'], '953': ['BIND remote name daemon control '], '981': [
                'Remote HTTPS management for firewall devices running embedded Check Point VPN 1 software'],
                     ...
                     '994': ['None', 'Internet Relay Chat over TLS/SSL '],
                     '995': ['Post Office Protocol 3 over TLS/SSL '],
                     '1010': ['ThinLinc web based administration interface', 'Official', 'Reserved', 'Yes', 'Reserved',
                              '1027', 'Official', 'Official'], '1028': ['Deprecated'],
                     '1029': ['Microsoft DCOM services'], '1058': ['nim, IBM AIX Network Installation Manager '],
                     '1059': ['nimreg, IBM AIX Network Installation Manager '], '1080': ['SOCKS proxy'],
                     '1085': ['WebObjects'], '1098': ['rmiactivation, Java remote method invocation '],
                     ...
                     '1341': ['Qubes '], '1344': ['Internet Content Adaptation Protocol'],
                     '1352': ['IBM Lotus Notes/Domino '], '1360': ['Mimer SQL'], '1414': ['IBM WebSphere MQ '],
                     '1417': ['Timbuktu Service 1 Port'], '1418': ['Timbuktu Service 2 Port'],
                     '1419': ['Timbuktu Service 3 Port'], '1420': ['Timbuktu Service 4 Port'],
                     ...
                     '1581': ['MIL STD 2045-47001 VMF', 'IBM Tivoli Storage Manager web client', 'None', '?', '1589',
                              'Official', 'DarkComet remote administration tool '], '1626': ['iSketch'],
                     '1627': ['iSketch'], '1628': ['LonTalk normal'], '1629': ['LonTalk urgent'], '1645': [
                'Early deployment of RADIUS before RFC standardization was done using UDP port number 1645. Enabled for compatibility reasons by default on Cisco'],
                     ...
                     '1813': ['RADIUS accounting protocol, radius-acct'], '1863': ['Microsoft Notification Protocol '],
                     '1880': ['Node-RED'], '1883': ['MQTT '], '1900': ['Simple Service Discovery Protocol '], '1935': [
                ...
                'Real Time Messaging Protocol '], '1967': ['Cisco IOS IP Service Level Agreements '],
                     ...
                     '2083': ['Secure RADIUS Service ', 'cPanel default SSL'],
                     '2086': ['GNUnet', 'WebHost Manager default'], '2087': ['WebHost Manager default SSL'],
                     '2095': ['cPanel default web mail'], '2096': ['cPanel default SSL web mail'],
                     ...
                     '2104': ['Zephyr Notification Service hostmanager'], '2123': ['GTP control messages '],
                     '2142': ['TDMoIP '], '2152': ['GTP user data messages '], '2159': ['GDB remote debug port'],
                     ...
                     '2303': ['ArmA multiplayer ', 'Halo: Combat Evolved multiplayer listener'],
                     '2305': ['ArmA multiplayer '], '2351': ['AIM game LAN network port'], '2368': ['Ghost '],
                ...
                'Default for BMC Control-M/Server, to allow the Control-M/Enterprise Manager to connect to the Control-M/Server'],
                     ...
                     '2380': ['CoreOS etcd server communication'], '2389': ['OpenView Session Mgr'],
                ...
                'IEC 60870-5-104, used to send electric power telecontrol messages between two systems via directly connected data circuits'],
                     ...
                     '2480': ['OrientDB database listening for HTTP client connections'], '2483': [
                'Oracle database listening for insecure client connections to the listener, replaces port 1521'],
                     ...
                     '3128': ['Squid caching web proxy'], '3225': ['Fibre Channel over IP '],
                     '3233': ['WhiskerControl research control protocol'], '3260': ['iSCSI'],
                     ...
                     '3389': ['Microsoft Terminal Server '], '3396': ['Novell NDPS Printer Agent'],
                     '3412': ['xmlBlaster'], '3455': ['Resource Reservation Protocol '],
                     ...
                     '3478': ['STUN, a protocol for NAT traversal', 'TURN, a protocol for NAT traversal',
                              'STUN Behavior Discovery.'], '3479': ['PlayStation Network'],
                     ...
                     '3667': ['Information Exchange'], '3689': ['Digital Audio Access Protocol '],
                     '3690': ['Subversion '], '3702': ['Web Services Dynamic Discovery '],
                     '3724': ['Some Blizzard games', 'Club Penguin Disney online game for kids'],
                     '3725': ['Netia NA-ER Port'], '3768': ['RBLcheckd server daemon'],
                     '3784': ['Bidirectional Forwarding Detection '], '3785': ['VoIP program used by Ventrilo'],
                     '3799': ['RADIUS change of authorization'], '3804': ['Harman Professional HiQnet protocol'],
                     ...
                     '4096': ['Ascom Timeplex Bridge Relay Element '], '4105': ['Shofar '], '4111': ['Xgrid'],
                     '4116': ['Smartcard-TLS'], '4125': ['Microsoft Remote Web Workplace administration'],
                     '4172': ['Teradici PCoIP'], '4190': ['ManageSieve'], '4198': ['Couch Potato Android app'],
                     '4201': ['TinyMUD and various derivatives'], '4222': ['NATS server default port'],
                     ...
                     '4244': ['Viber'], '4303': ['Simple Railroad Command Protocol '],
                     ...
                     '4444': ['Oracle WebCenter Content: Content Serverâ€”Intradoc Socket port. ',
                              "Metasploit's default listener port", 'Xvfb X server virtual frame buffer service',
                              'None', 'Yes', '4488', 'Official', 'IPSec NAT Traversal', 'None', 'Yes', '4534',
                              'Unofficial', 'default Log4j socketappender port'],
                     '4567': ['Sinatra default server port in development mode '], '4569': ['Inter-Asterisk eXchange '],
                     ...
                     '4728': ['Computer Associates Desktop and Server Management '], '4730': ["Gearman's job server"],
                     '4739': ['IP Flow Information Export'], '4747': ['Apprentice'], '4753': ['SIMON '],
                     '4789': ['Virtual eXtensible Local Area Network '], '4840': ['OPC UA Connection Protocol '],
                     ...
                     '4894': ['LysKOM Protocol A'], '4949': ['Munin Resource Monitoring Tool'],
                     '4950': ['Cylon Controls UC32 Communications Port'],
                     '5000': ['UPnPâ€”Windows network device interoperability', 'VTun, VPN Software',
                              'FlightGear multiplayer', 'Synology Inc. Management Console, File Station, Audio Station',
                              'Flask Development Webserver', 'Heroku console access', 'Docker Registry',
                              'AT&T U-verse public, educational, and government access ',
                              'High-Speed SECS Message Services', 'Yes', 'Yes', 'Yes', 'Yes', '5002', 'Unofficial',
                              'FileMaker â€“ name binding and transport'],
                     '5004': ['Real-time Transport Protocol media data '],
                     '5005': ['Real-time Transport Protocol control protocol '],
                     '5010': ['Registered to: TelePath ', 'Yes', 'Yes', 'Yes', 'Yes', '5048', 'Official',
                              'Yahoo! Messenger'], '5051': ['ita-agent Symantec Intruder Alert'],
                     '5060': ['Session Initiation Protocol '], '5061': ['Session Initiation Protocol '],
                     '5062': ['Localisation access'], '5064': ['EPICS Channel Access server'],
                     '5065': ['EPICS Channel Access repeater beacon'], '5070': ['Binary Floor Control Protocol '],
                     '5084': ['EPCglobal Low Level Reader Protocol '], '5085': ['EPCglobal Low Level Reader Protocol '],
                     ...
                     '5104': ['IBM Tivoli Framework NetCOOL/Impact'], '5121': ['Neverwinter Nights'],
                     '5124': ['TorgaNET '], '5125': ['TorgaNET '], '5150': ['ATMP Ascend Tunnel Management Protocol'],
                     ...
                     '5242': ['Viber'], '5243': ['Viber'],
                     '5246': ['Control And Provisioning of Wireless Access Points '],
                     ...
                     '5349': ['STUN over TLS/DTLS, a protocol for NAT traversal',
                              'TURN over TLS/DTLS, a protocol for NAT traversal', 'STUN Behavior Discovery over TLS.'],
                     '5351': [
                     ...
                     '5402': ['Multicast File Transfer Protocol '], '5405': ['NetSupport Manager'],
                     '5412': ['IBM Rational Synergy '], '5413': ['Wonderware SuiteLink service'], '5417': ['SNS Agent'],
                     '5421': ['NetSupport Manager'], '5432': ['PostgreSQL'], '5433': ['Bouwsoft file/webserver'],
                     '5445': ['Cisco Unified Video Advantage'], '5480': ['VMware VAMI '],
                     ...
                     '5550': ['Hewlett-Packard Data Protector'], '5554': ['Fastboot default wireless port'],
                     ...
                     '5666': ['NRPE '], '5667': ['NSCA '], '5670': ['FILEMQ ZeroMQ File Message Queuing Protocol',
                                                                    'ZRE-DISC ZeroMQ Realtime Exchange Protocol '],
                     '5671': ['Advanced Message Queuing Protocol '], '5672': ['Advanced Message Queuing Protocol '],
                     '5683': ['Constrained Application Protocol '],
                     '5684': ['Constrained Application Protocol Secure '], '5693': ['Nagios Cross Platform Agent '],
                     '5701': ['Hazelcast default communication port'], '5722': ['Microsoft RPC, DFSR '],
                     '5718': ['Microsoft DPM Data Channel '], '5719': ['Microsoft DPM Data Channel '],
                     '5723': ['System Center Operations Manager'], '5724': ['Operations Manager Console'],
                     '5741': ['IDA Discover Port 1'], '5742': ['IDA Discover Port 2'],
                     ...
                     '5986': ['Windows PowerShell Default psSession Port', 'None', 'Yes', 'None', 'Yes', '6050',
                              'Unofficial', 'Arcserve backup'], '6086': ['Peer Distributed Transfer Protocol '],
                     '6100': ['Vizrt System', 'Ventrilo authentication for version 3'],
                     '6101': ['Backup Exec Agent Browser'], '6110': ['softcm, HP Softbench CM'],
                     ...
                     '6255': ['Oracle WebCenter Content Portable: Inbound Refineryâ€”Intradoc Socket port'],
                     '6257': ['WinMX '], '6260': ['planet M.U.L.E.'], '6262': ['Sybase Advantage Database Server'],
                     ...
                     '6432': ['PgBouncerâ€”A connection pooler for PostgreSQL'],
                     '6436': ['Leap Motion Websocket Server TLS'], '6437': ['Leap Motion Websocket Server'],
                     '6444': ['Sun Grid Engine Qmaster Service'],
                     '6445': ['Sun Grid Engine Execution Service', 'None', 'Yes', 'Yes', '6513', 'Official',
                     ...
                     '6556': ['Check MK Agent'], '6566': ['SANE ', 'None', 'None', '6600', 'Official', 'Unofficial',
                     ...
                     '6771': ['BitTorrent Local Peer Discovery', 'None', 'Yes', '6888', 'Official', 'Unofficial',
                              'BitTorrent part of full range of ports used most often', 'Yes', 'Yes', '6901',
                              'Unofficial', 'Unofficial', 'BitTorrent part of full range of ports used most often'],
                     '6969': ['acmsoda', 'BitTorrent tracker', 'Yes', 'Yes', 'Yes', 'None', 'Yes', 'Yes', '7002',
                              'Unofficial',
                     ...
                     '7133': ['Enemy Territory: Quake Wars'], '7144': ['Peercast'], '7145': ['Peercast'],
                     '7171': ['Tibia'], '7262': ['CNAP '], '7272': ['WatchMe - WatchMe Monitoring'],
                     '7306': ['Zimbra mysql '], '7307': ['Zimbra mysql '], '7312': ['Sibelius License Server'],
                     '7396': ['Web control interface for Folding@home v7.3.6 and later'], '7400': ['RTPS '],
                     '7401': ['RTPS '], '7402': ['RTPS '], '7471': ['Stateless Transport Tunneling '],
                     '7473': ['Rise: The Vieneo Province'], '7474': ['Neo4J Server webadmin'],
                     '7478': ['Default port used by Open iT Server.'], '7542': ['Saratoga file transfer protocol'],
                     '7547': ['CPE WAN Management Protocol '], '7575': ['Populous: The Beginning server'],
                     '7624': ['Instrument Neutral Distributed Interface'], '7631': ['ERLPhase'],
                     '7634': ['hddtempâ€”Utility to monitor hard drive temperature', '7655', 'Unofficial',
                              'BrettspielWelt BSW Boardgame Portal'], '7687': ['Bolt database connection'],
                     '7717': ['Killing Floor'],
                     '7777': ['iChat server file transfer proxy', 'Oracle Cluster File System 2',
                              'Windows backdoor program tini.exe default', 'Just Cause 2: Multiplayer Mod Server',
                              'Terraria default server', 'San Andreas Multiplayer '],
                     ...
                     '8008': ['Alternative port for HTTP. See also ports 80 and 8080.',
                              'IBM HTTP Server administration default', 'iCal, a calendar application by Apple'],
                     '8009': ['Apache JServ Protocol '], '8010': ['Buildbot Web status page'],
                     '8042': ['Orthanc â€“ REST API over HTTP'], '8069': ['OpenERP 5.0 XML-RPC protocol'],
                     '8070': ['OpenERP 5.0 NET-RPC protocol'], '8074': ['Gadu-Gadu'],
                     ...
                     '8091': ['CouchBase web administration'], '8092': ['CouchBase API'],
                     '8111': ['JOSM Remote Control'], '8112': ['PAC Pacifica Coin'],
                     '8116': ['Check Point Cluster Control Protocol'],
                     '8118': ['Privoxyâ€”advertisement-filtering Web proxy'], '8123': ['Polipo Web proxy'],
                     '8139': ['Puppet '], '8140': ['Puppet '],
                     ...
                     '8245': ['Dynamic DNS for at least No-IP and DyDNS'], '8280': ['HTTP listener for Apache Synapse'],
                     '8281': ['HTTP Listener for Gatecraft Plugin'], '8291': [
                'Winboxâ€”Default on a MikroTik RouterOS for a Windows application used to administer MikroTik RouterOS'],
                     ...
                     '8443': ['SW Soft Plesk Control Panel', 'Apache Tomcat SSL', 'Promise WebPAM SSL',
                              'iCal over SSL'], '8444': ['Bitmessage'], '8484': ['MapleStory Login Server'],
                     ...
                     '8983': ['Apache Solr'], '8997': ['Alternate port for I2P Monotone Proxy'],
                     '8998': ['I2P Monotone Proxy'], '8999': ['Alternate port for I2P Monotone Proxy'],
                     ...
                     '9001': ['ETL Service Manager', 'Microsoft SharePoint authoring environment',
                              'cisco-xremote router configuration', 'Tor network default', 'DBGp Proxy',
                              'HSQLDB default port'], '9002': ['Newforma Server comms'],
                     '9006': ['De-Commissioned Port', 'Tomcat in standalone mode'], '9030': ['Tor often used'],
                     '9042': ['Apache Cassandra native protocol clients'],
                     '9043': ['WebSphere Application Server Administration Console secure', 'None', 'Yes', '9080',
                              'Official', 'Unofficial', 'Unofficial', 'Unofficial', 'Openfire Administration Console',
                     ...
                     '9101': ['Bacula Director'], '9102': ['Bacula File Daemon'], '9103': ['Bacula Storage Daemon'],
                     '9119': ['MXit Instant Messenger'], '9150': ['Tor'], '9191': ['Sierra Wireless Airlink'],
                     '9199': ['Avtex LLCâ€”qStats'], '9200': ['Elasticsearch'], '9217': ['iPass Platform Service'],
                     '9293': ['Sony PlayStation RemotePlay'], '9300': ['IBM Cognos BI'],
                     '9303': ['D-Link Shareport Share storage and MFP printers'], '9306': ['Sphinx Native API'],
                     ...
                     '10308': ['Lock On: Modern Air Combat'], '10480': ['SWAT 4 Dedicated Server'],
                     '10505': ['BlueStacks '], '10514': ['TLS-enabled Rsyslog '], '10823': ['Farming Simulator 2011'],
                     '10891': ['Jungle Disk '], '10933': ['Octopus Deploy Tentacle deployment agent'],
                     '11001': ['metasys '], '11111': ['RiCcI, Remote Configuration Interface '],
                     ...
                     '12046': ['Second Life, used for LSL HTTP in-bound'], '12201': ['Graylog Extended Log Format '],
                     '12222': ['Light Weight Access Point Protocol '], '12223': ['Light Weight Access Point Protocol '],
                     ...
                     '15441': ['ZeroNet fileserver'], '15567': ['Battlefield Vietnam and mods'],
                     '15345': ['XPilot Contact'], '15672': ['RabbitMQ management plugin'],
                     '16000': ['Oracle WebCenter Content: Imaging ', 'shroudBNC'], '16080': ['Mac OS X Server Web '],
                     '16200': ['Oracle WebCenter Content: Content Server '], '16225': [
                ...
                'Project Zomboid multiplayer. Additional sequential ports used for each player connecting to server.'],
                     ...
                     '16567': ['Battlefield 2 and mods'], '17011': ['Worms multiplayer'],
                     '17500': ['Dropbox LanSync Protocol '], '18080': ['Monero P2P network communications'],
                     '18081': ['Monero incoming RPC calls'], '18091': ['memcached Internal REST HTTPS for SSL'],
                     '18092': ['memcached Internal CAPI HTTPS for SSL'], '18104': ['RAD PDF Service'],
                     ...
                     '19000': ['Audition Online Dance Battle, G10/alaplaya Server status/version check',
                               'JACK sound server'], '19001': ['Audition Online Dance Battle, G10/alaplaya Server'],
                     ...
                     '19999': ['Distributed Network Protocolâ€”Secure '], '20000': ['Distributed Network Protocol ',
                                                                                    'Usermin, Web-based Unix/Linux user administration tool ',
                     ...
                     '21025': ['Starbound Server '], '22000': ['Syncthing '],
                     '22136': ['FLIR Systems Camera Resource Protocol'], '22222': ['Davis Instruments, WeatherLink IP'],
                     '23073': ['Soldat Dedicated Server'], '23399': ['Skype default protocol'],
                     '23513': ['Duke Nukem 3D source ports'], '24441': ['Pyzor spam detection network'],
                     ...
                     '26000': ["id Software's Quake server", 'EVE Online', 'Xonotic, an open-source arena shooter',
                               'None', 'Yes', '27000â€“27006', 'Unofficial', "FlexNet Publisher's License server ",
                               'Yes', 'No', '27016', 'Unofficial', 'MongoDB daemon process '], '27031': ['Steam '],
                     '27036': ['Steam '], '27037': ['Steam '], '27374': ['Sub7 default.'], '27888': ['Kaillera server'],
                     '27950': ['OpenArena outgoing'], '28001': ['Starsiege: Tribes'], '28015': ['Rust '],
                     '28852': ['Killing Floor'], '28910': ['Nintendo Wi-Fi Connection'], '28960': [
                'Call of Duty; Call of Duty: United Offensive; Call of Duty 2; Call of Duty 4: Modern Warfare;'],
                     ...
                     '31337': ['Back Orifice and Back Orifice 2000 remote administration tools'],
                     '31416': ['BOINC RPC'], '31438': ['Rocket U2'], '31457': ['TetriNET'],
                     '32137': ['Immunet Protect '], '32400': ['Plex Media Server'], '32764': [
                'A backdoor found on certain Linksys, Netgear and other wireless DSL modems/combination routers'],
                     ...
                     '32976': ['LogMeIn Hamachi, a VPN application; also TCP port 12975 and SSL '],
                     '33434': ['traceroute'], '33848': ['Jenkins, a continuous integration '],
                     '34000': ['Infestation: Survivor Stories '],
                     '34197': ['Factorio, a multiplayer survival and factory-building game'],
                     '35357': ['OpenStack Identity '], '37008': ['TZSP intrusion detection'],
